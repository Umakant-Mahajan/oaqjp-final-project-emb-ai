...
class TestEmotionDetector(unittest.TestCase):  # Fixed inheritance
    def testEmo(self):
        ...
        self.assertEqual(emotion_detector("I feel disgusted just hearing about this")['dominant_emotion'], "disgust")  # Fixed parentheses
